let blogName = "vio's site";
let authorName = "vio";
let authorLink = "https://twitter.com/computerphile"; 
...
function formatButton(i) {
  let image = buttonsArray[i][0];
  let link = buttonsArray[i][1];
  let alt = buttonsArray[i][2];

  if ( image === "" ) {
    return '<div class="button-placeholder">' + alt + '</div>';
  }
  ...
  let button = '<img src="' + image + '" alt="' + alt + '" title="' + alt + '">';
...
if (document.getElementById("footer")) {
  document.getElementById("footer").innerHTML = footerHTML + buttonsHTML;
}
